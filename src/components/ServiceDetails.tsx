      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="lg:w-1/2">
            ...
            <p className="text-xl text-earth-600 mb-8">{service.subtitle}</p>

            <p className="text-lg text-earth-700 mb-8">{service.description}</p>
          ...
          <div className="lg:w-1/2">
            <div className="sticky top-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-earth-100 p-6 rounded-xl">
                  <h3 className="font-display text-xl font-semibold mb-3">
                    Start a Conversation
                  </h3>
                  <p className="text-earth-600 mb-4">
                    Curious about how this service can help your business? Let's
                    chat.
                  </p>
                  <Button
                    variant="outline"
                ...
                <div className="bg-tribe-blue/10 p-6 rounded-xl">
