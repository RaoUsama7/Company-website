...
import { ArrowLeft, CheckCircle, Building2, Users, CreditCard, FileText, Globe, Bell, Search, ShieldCheck, ChevronLeft, ChevronRight } from 'lucide-react';
                        ...
                        <div className="relative group h-64 md:h-[500px] rounded-2xl overflow-hidden shadow-2xl bg-earth-900/20 border border-white/10">
                            <AnimatePresence mode="wait">
                                <motion.img
                                    ...
                                    alt={`Rentigo Project Slide ${currentIndex + 1}`}
