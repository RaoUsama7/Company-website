...
import { ArrowLeft, CheckCircle, ShoppingBag, Zap, Shield, Globe, Sparkles, Smartphone, BarChart, Settings, Gem, ChevronLeft, ChevronRight } from 'lucide-react';
                        ...
                        <div className="relative group h-64 md:h-[500px] rounded-2xl overflow-hidden shadow-2xl bg-earth-900/20 border border-white/10">
                            <AnimatePresence mode="wait">
                                <motion.img
                                    ...
                                    alt={`DANI Project Slide ${currentIndex + 1}`}
